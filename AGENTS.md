...
30. [UX] Never change the visible site header when the user asks for a site logo unless they explicitly ask for in-page integration — this user only wanted browser/tab branding.
